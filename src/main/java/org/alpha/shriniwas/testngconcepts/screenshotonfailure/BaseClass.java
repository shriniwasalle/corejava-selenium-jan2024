...
public class BaseClass {
    ...
    public void captureScreenshot(String fileName) throws IOException {
        try {
            ...
            File destFile = new File( System.getProperty("user.dir")+"\\src\\main\\java\\org\\alpha\\shriniwas\\testngconcepts\\screenshotonfailure\\screenshots\\"+fileName + dateTime+".jpg");
