package org.alpha.shriniwas.seleniumconcepts.assignments.assignment10.pages;
...
public class LoanPage {
    ...
    private final By tdHeaderText = By.xpath("//table/tbody/tr[contains(@class, 'yearlypaymentdetails')][1]//td[text()]");
