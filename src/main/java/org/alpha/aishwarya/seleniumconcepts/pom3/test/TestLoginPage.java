...
import org.alpha.aishwarya.seleniumconcepts.pom3.utils.ReadPropertiesFile;
...
public class TestLoginPage extends BaseTest {
    ...
    public void initBrowser() throws IOException {
        ...
        driver = initBrowser(URL, ReadPropertiesFile.getPropertyValue("browser"));

        // method mdhye method paramete called "Properties file cha"
       // Method Static aahe mhun directly class name access kelo: ReadPropertiesFile.getPropertyValue("browser")
    }

    /**  ====== OR other Way: Using variable store ======
     *
     *   public void initBrowser() throws IOException {
     *   String url = ReadPropertiesFile.getPropertyValue(key:"url")
     *   String browser = ReadPropertiesFile.getPropertyValue(key:"browser")
