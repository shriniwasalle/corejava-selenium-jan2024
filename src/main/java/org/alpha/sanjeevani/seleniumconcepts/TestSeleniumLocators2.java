...
public class TestSeleniumLocators2 {
    public static void main(String[] args) throws InterruptedException {
        ...
        List<WebElement> txtBoxes = driver.findElements(By.xpath("//input[@autocapitalize='none']"));
...
// when we have multiple elements then we should use "findElements" and must be stored in List<WebElement>.